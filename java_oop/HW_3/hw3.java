...
public class hw3 {
    public static void main(String[] args) {
        ...
        students.add(new Students("Алексей", "Петров", 5));
        students.add(new Students("Василий", "Соловьев", 4));
        students.add(new Students("Михаил", "Марков", 5));
        students.add(new Students("Екатерина", "Ветрова", 3));
        students.add(new Students("Владислав", "Листьев", 2));
        students.add(new Students("Мария", "Петрова", 5));
