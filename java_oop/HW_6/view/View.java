package java_oop.HW_6.view;

import java.util.Map;

import java_oop.HW_6.controller.VendingMachineController;
...
/*В процесс решения задачи был реализован принцип SOLID.
 * Основной задачей было продемонстрировать как можно реализовать поставленную задачу таким образом, что бы дальнейшая
 ...
 * 
 * Архитектурные слои:
 * 1) View ни чего не занет о том что у нас под капотом, имеет доступ только к контроллеру автомата,
 ...
 * 
 * Изменения по сравнению с семинаром 4 следующие: поскольку был реализован принцип SOLID при проектировании данного приложения
